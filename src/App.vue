          ...
          <div class="flex-grow flex">
            ...
            <section class="md:hidden fixed bottom-0 left-0 right-0 p-4 bg-gray-800 text-white text-center shadow-lg rounded-t-lg">
              <div class="flex justify-around">
                <button @click="selectTab('home')" class="bg-blue-500 px-4 py-3 rounded-full hover:bg-blue-600 transition duration-200 focus:outline-none focus:ring-2 focus:ring-blue-300 focus:ring-opacity-50"><HomeIcon class="h-6 w-6" /></button>
